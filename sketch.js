...
function preload(){
  ...
  //Loading Images
  //Bg Images
  background1_img = loadImage("Bg1.webp");
  background2_img = loadImage("Bg2.png");

  //Tortoise Images
  tortoise_img = loadImage("playT.png");
  angryT_img = loadImage("revenge.png");

  //Shark Images
  greetShark_img = loadImage("Greet.png");

  //Texts & Text's Images
  hello_img = loadImage("hello.png")
  title_img = loadImage("Title.png");
  space_img = loadImage("Space.png");
  n_img = loadImage("N.png");
  welcome_img = loadImage("Welcome.png");
  rules_img = loadImage("Rules.png");
  goal_img = loadImage("Goal.png");
  myName_img = loadImage("Creater.png");
  story1_img = loadImage("Story1.png");
  story2_img = loadImage("Story2.png");
  WelcomeSound = loadImage("welcomeSound.png");
  startSound_img = loadImage("startSound.png");
  tortoiseScared_img = loadImage("scaredT.png");
  crab1_img  = loadImage("Crab.png");
  crab2_img = loadImage("Crab2.png");

  //Loading Sound
  game_Sound = loadSound("Game.mp3");
  welcome_Sound = loadSound("Welcome.mp3");
...
function spawnSharks(){
    if (gameState === 4 && frameCount % 80 === 0){
      var shark1 = createSprite(displayWidth/2,Math.round(random(70, 300)),10,40);
       shark1.velocityX = -3;
      ...
      //add each obstacle to the group
       ...
       var shark2 = createSprite(displayWidth/2,100,10,40);
       shark2.velocityY = 4;
